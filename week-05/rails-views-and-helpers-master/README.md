...
OPTIONAL: To follow along:

``` 
# Download the repo and go into the rails project folder

# Use Rails 2.5.0
rvm use 2.5.0

# Install gems for this app
bundle install
...
### Independent Practice: Add a Detail View

Add a view that the user can see if they click on a message. 
* Create a `show.html.erb`
* Make sure you display the guest message and author on the page
